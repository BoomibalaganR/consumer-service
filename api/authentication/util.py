...
def send_password_reset_email(consumer, token, subject=" VitaGist Personal Password Reset."):
...
def send_password_change_email(consumer, subject="Password Change Successful",):
    payload = {
