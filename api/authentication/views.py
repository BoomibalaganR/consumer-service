...
from .serializers import (
    ConsumerAuthResponseSerializer,
    ConsumerCreateSerializer,
    ForgotPasswordSerializer,
    LoginSerializer,
    ResendPasswordTokenSerializer,
...
class LoginView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            data={"token": token, "data": serializer.data}, status=status.HTTP_200_OK
        )
...
class ForgotPasswordView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "detail": "A token to reset your password is sent to your email. It is valid for 5 mins",
                "reset-token": token,
            },
